...
(function (global, factory) {
	...
	*/
	...
	class Alert {
	  ...
	  constructor(opts) {
	    this.el = opts.el;
	    this.dismiss = this.el.querySelector(Selector$q.DISMISS);
	...
	*/
	  ...
	  update(value) {
	    ...
	    if (typeof value === 'string') {
	      ...
	      if (value) {
	        ...
	        this.container.dispatchEvent(this[EventName$o.ON_UPDATE]);
	...
	function _reallocateSlideItems() {
	  ...
	  if (slidesToAdd > 0) {
	    ...
	    for (let i = 0; i < slidesToAdd; i++) {
	      ...
	      const newParent = newNode.querySelector(Selector$m.ROW);
	...
	class Collapse {
	  ...
	  constructor(_ref) {
	    ...
	    this[EventName$h.HIDDEN] = new CustomEvent(EventName$h.HIDDEN);
	...
	class CollapseControls {
	  ...
	  constructor(opts) {
	    ...
	    if (!this.collapseList.length) {
	      const collapseTriggers = this.accordion.querySelectorAll(Selector$j.DATA_MOUNT);
	...
	function _initializeImageSrc() {
	  ...
	  const defaultElement = currentFieldSet.querySelector(Selector$g.CHECKED);
	...
	function _initInstance(opts) {
	  ...
	  this.controls = [];
	  const controls = this.el.querySelectorAll(Selector$g.CONTROL);
	...
	class ComboboxSelect {
	  ...
	  constructor(_ref) {
	    ...
	    this.optionEls = el.querySelectorAll(Selector$f.ROLE_OPTION);
	    this.comboboxText = document.querySelector(Selector$f.DATA_TEXT);
	...
	function _onOptionChange2(index) {
	  ...
	  this.optionEls[index].classList.add(ClassName$c.CURRENT_ITEM);
	...
	class Flyout {
	  ...
	  positionMenu() {
	    ...
	    this.menu.classList.remove(`${ClassName$b.FLYOUT}-left`, `${ClassName$b.FLYOUT}-right`, `${ClassName$b.FLYOUT}-top`, `${ClassName$b.FLYOUT}-bottom`, `${ClassName$b.FLYOUT}-align-start`, `${ClassName$b.FLYOUT}-align-end`, `${ClassName$b.FLYOUT}-align-center`);
	  ...
	  show() {
	    ...
	    this.menu.classList.add(ClassName$b.SHOW);
	  ...
	  hide(opts) {
	    ...
	    this.menu.classList.remove(ClassName$b.SHOW);
	...
	function _inputCheckReducer(input) {
	  ...
	  return [].slice.call(this.inputs).reduce((obj, _input) => {
	    if (_input.type === type && _input.name === name) {
	      ...
	      const maxValid = _input.getAttribute(Selector$b.CHECKBOX_MAX);
	...
	function _setScrollbar() {
	  if (this.isBodyOverflowing) {
	    ...
	    const stickyContent = [].slice.call(document.querySelectorAll(Selector$a.STICKY_CONTENT));
	...
	class Modal {
	  ...
	  constructor(_ref) {
	    ...
	    this[EventName$a.CLICK_DISMISS] = new CustomEvent(EventName$a.CLICK_DISMISS);
	  ...
	  show() {
	    ...
	    this.el.addEventListener(EventName$a.CLICK_DISMISS, this.hide);
	  ...
	  if (this.inCustomViewport()) {
	    ...
	    imagesloadedExports(this.el, () => {
	      ...
	      this.collapses.forEach((c, i) => {
	        ...
	        const dNone = c.feature.classList.contains(ClassName$6.DISPLAY.NONE);
	...
	function _onShown(collapse) {
	  this.open = collapse;
	  if (this.inCustomViewport()) {
	    this.open.feature?.classList.remove(ClassName$6.DISPLAY.NONE);
	...
	function _onHide(e) {
	  ...
	  if (this.inCustomViewport()) {
	    if (otherOpen) {
	      this.open.feature?.classList.add(ClassName$6.DISPLAY.NONE);
	    } else {
	      e.preventDefault();
	    }
	  } else if (!otherOpen) {
	...
	function _valueChanged() {
	  if (!this.value || this.el.value !== this.value) {
	    ...
	    this.el.dispatchEvent(this[EventName$5.ON_CHANGE]);
	...
	class Scrollspy {
	  ...
	  constructor(opts) {
	    ...
	    this.offset = opts.offset || parseInt(this.el.dataset[Selector$4.OFFSET], 10) || Default.OFFSET;
	...
	function _showHideArrow() {
	  ...
	  if (imageTab) {
	    imagesloadedExports(tabListWindow, () => {
	      const arrowTargetHeight = imageTab.offsetHeight - (imageTab.querySelector(Selector.IMAGE_TAB_LABEL).offsetHeight - 1 || 0); // Added (- 1) to the calculation to count for the Image Underline variant height
